// Duas versoes do prompt do agente de sugestao de receita.
// v1 nao obriga o uso das ferramentas (bug proposital pra Aula 4).
// v2 corrige isso, obrigando tool use antes de sugerir qualquer prato.
