...
const aula4 = [
  { type: 'cover',
    ...
    meta: 'Quatro falhas reais, achadas em produção — evidência real, sem simulação' },

  { type: 'divider', number: '4.1', title: 'Detectando degradação' },
  { type: 'bullets', eyebrow: 'Vídeo 4.1', title: 'O estado em produção hoje',
    bullets: [
      'Meu produto está no ar, com dados reais e chamadas de modelo pagas.',
      'Nenhum alarme disparou. Nenhum usuário reclamou. E há duas falhas ativas neste momento.',
      { text: 'Falha que não grita é a regra, não a exceção — detectar é trabalho ativo, não espera.', bold: true },
    ] },
  { type: 'table', eyebrow: 'Vídeo 4.1 — dado real (14/09)', title: 'Eixo de custo, por operação',
    header: ['Operação', 'n', 'Custo médio', 'Latência média', '% do custo'],
    rows: [
      ['mediar-cardapio', '10', 'US$ 0,1381', '55,9 s', '90 %'],
      ['receita-premium-semanal', '6', 'US$ 0,0115', '7,3 s', '5 %'],
      ['ingerir-relato', '17', 'US$ 0,0032', '1,6 s', '4 %'],
      ['ingerir-nota-imagem', '2', 'US$ 0,0071', '3,3 s', '1 %'],
      ['ingerir-nota-fiscal', '2', 'US$ 0,0054', '2,7 s', '1 %'],
    ] },
  { type: 'bullets', eyebrow: 'Vídeo 4.1', title: '26% das chamadas, 90% da conta',
    bullets: [
      ...
      'Com a leitura de nota por foto, são três eixos trocáveis ao vivo: geração, ingestão e visão.',
    ] },
  { type: 'bullets', eyebrow: 'Vídeo 4.1', title: 'A falha que não deixou rastro',
    bullets: [
      'Mandei a foto de um cupom pro bot. Nada aconteceu: sem resposta, sem item, sem reação.',
      'Fui atrás do rastro: log vazio, trace vazio, banco sem mudança — e o Telegram confirma que entregou.',
      { text: 'Se o canal confirma a entrega e o sistema não registra nada, onde essa mensagem foi parar?', bold: true },
    ] },
  ...
  { type: 'bullets', eyebrow: 'Vídeo 4.2 — episódio D, 14/09', title: 'O hambúrguer que sumiu',
    bullets: [
      'O sintoma: preparei um hambúrguer, contei pro bot, respondi a pergunta dele — três vezes, de jeitos diferentes.',
      { text: 'O que eu junto: as quatro classificações estão perfeitas. Zero erro, zero exceção.', bold: true },
      'E mesmo assim, o prato nunca entrou no estoque. Resultado líquido zero, sem uma falha visível.',
      'O que eu levo ao Claude: “prompt, dados ou modelo — qual dos três explica isso?” Resposta: nenhum. É o sistema que não guarda memória entre mensagens.',
    ] },
  { type: 'bullets', eyebrow: 'Vídeo 4.2', title: 'O que os quatro casos têm em comum',
    bullets: [
      ...
      { text: 'E no quarto, cada peça isolada estava certa — a soma delas ainda assim falhou. Quem errou foi o produto em volta do modelo, ou a peça que nunca existiu.', bold: true },
    ] },
  ...
  { type: 'bullets', eyebrow: 'Vídeo 4.4', title: 'O que essa correção criou',
    bullets: [
      ...
      'A saída óbvia pra lasanha seria o produto perguntar em vez de chutar — só que esse mecanismo já existe, e foi ele que quebrou no episódio do hambúrguer.',
  ...
  { type: 'bullets', eyebrow: 'Fechamento da aula', title: 'O que aprendemos',
    bullets: [
      'Quatro falhas reais, e nenhuma gritou. Três eu fui atrás olhando; a quarta apareceu sozinha, usando o produto de verdade.',
      'Eu não li código para diagnosticar: observei, juntei evidência e perguntei.',
      { text: 'A inteligência acertou nos quatro casos — inclusive quatro vezes seguidas no mais difícil. Quem falhou foi o produto em volta dela.', bold: true },
