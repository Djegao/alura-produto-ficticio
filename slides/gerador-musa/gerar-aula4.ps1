# Gera o deck inicial da Aula 4 (v1, pre-debate) reaproveitando slides JA
...
#
#   powershell -File gerar-aula4.ps1
#
# Feche o PowerPoint antes de rodar. O deck sai como
# "Aula 4 6498 - inicial.pptx" na pasta slides/, pra revisao no Google Slides.
param(
  [string]$Spec   = "$PSScriptRoot\aula4-spec.json",
  [string]$Fonte  = "$PSScriptRoot\..\Aula 2 6498 - inicial.pptx",
  [string]$Out    = "$PSScriptRoot\..\Aula 4 6498 - inicial.pptx",
  [switch]$SemNotas
)
