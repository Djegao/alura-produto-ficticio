# Gera o deck inicial da Aula 5 (v1, pre-debate) reaproveitando slides JA
...
#
#   powershell -File gerar-aula5.ps1
#
# Feche o PowerPoint antes de rodar. O deck sai como
# "Aula 5 6498 - inicial.pptx" na pasta slides/, pra revisao no Google Slides.
param(
  [string]$Spec   = "$PSScriptRoot\aula5-spec.json",
  [string]$Fonte  = "$PSScriptRoot\..\Aula 2 6498 - inicial.pptx",
  [string]$Out    = "$PSScriptRoot\..\Aula 5 6498 - inicial.pptx",
  [switch]$SemNotas
)
